...
class Application
{
	...
	//std::initializer_list<std::vector<vector3>> stopsList;
	std::vector<matrix4> matrixList;
	std::vector<vector3> stopList;
	std::vector<vector3> stopList2;
	std::vector<vector3> stopList3;
	std::vector<vector3> stopList4;
	std::vector<vector3> stopList5;
	std::vector<vector3> stopList6;
	std::vector<vector3> stopList7;
	//calculate the current position
	vector3 v3CurrentPos = ZERO_V3;
	vector3 v3Start; //start point
	vector3 v3End; //end point

	vector3 v3CurrentPos2 = ZERO_V3;
	vector3 v3Start2; //start point
	vector3 v3End2; //end point

	vector3 v3CurrentPos3 = ZERO_V3;
	vector3 v3Start3; //start point
	vector3 v3End3; //end point

	vector3 v3CurrentPos4 = ZERO_V3;
	vector3 v3Start4; //start point
	vector3 v3End4; //end point

	vector3 v3CurrentPos5 = ZERO_V3;
	vector3 v3Start5; //start point
	vector3 v3End5; //end point

	vector3 v3CurrentPos6 = ZERO_V3;
	vector3 v3Start6; //start point
	vector3 v3End6; //end point

	vector3 v3CurrentPos7 = ZERO_V3;
	vector3 v3Start7; //start point
	vector3 v3End7; //end point
