...
void Application::CameraRotation(float a_fSpeed)
{
	...
	SetCursorPos(CenterX, CenterY);//Position the mouse in the center
    //m_pCamera->Rotation(fAngleX, fAngleY);
	...
	m_pCamera->SetTarget(cameraFront);
...
#pragma region Camera Position
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::W))
		...
		m_pCamera->SetPosition(m_pCamera->moveForward());
	vector3 m_v3Direction = glm::normalize(cameraPos - cameraFront);
	vector3 target = m_pCamera->getPosition() - vector3(0.0, 0.0, 1.0f);
	m_pCamera->SetTarget(target);
	vector3 m_v3Right1 = glm::normalize(glm::cross(cameraUp, m_v3Direction));
	vector3 m_v3cameraUp1 = glm::cross(m_v3Direction, m_v3Right1);
	m_pCamera->SetUp(m_v3cameraUp1);
	
		
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::S))
		m_pCamera->SetPosition(m_pCamera->moveBackward());
	m_pCamera->SetTarget(target);
	vector3 m_v3Right2 = glm::normalize(glm::cross(cameraUp, m_v3Direction));
	vector3 m_v3cameraUp2 = glm::cross(m_v3Direction, m_v3Right2);
	m_pCamera->SetUp(m_v3cameraUp2);
	
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::A))
		//m_pCamera->moveLeft();
		m_pCamera->SetPosition(m_pCamera->moveLeft());
	m_pCamera->SetTarget(target);
	vector3 m_v3Right3 = glm::normalize(glm::cross(cameraUp, m_v3Direction));
	vector3 m_v3cameraUp3 = glm::cross(m_v3Direction, m_v3Right3);
	m_pCamera->SetUp(m_v3cameraUp3);
	
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::D))
		m_pCamera->SetPosition(m_pCamera->moveRight());
	m_pCamera->SetTarget(target);
	vector3 m_v3Right4 = glm::normalize(glm::cross(cameraUp, m_v3Direction));
	vector3 m_v3cameraUp4 = glm::cross(m_v3Direction, m_v3Right4);
