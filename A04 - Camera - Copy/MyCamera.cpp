...
vector3 Simplex::MyCamera::moveForward()
{
	return m_v3Position += m_v3Direction * movementSpeed;
}
...
vector3 Simplex::MyCamera::moveBackward()
{
	return m_v3Position -= m_v3Direction * movementSpeed;

}
vector3 Simplex::MyCamera::moveLeft()
{
	return m_v3Position -= m_v3Right * movementSpeed;

}
vector3 Simplex::MyCamera::moveRight()
{
	return m_v3Position += m_v3Right * movementSpeed;
...
void Simplex::MyCamera::Rotation(float mouseX, float mouseY)
{
	m_m4View = glm::mat4(glm::rotate(-mouseX* 0.5f, m_v3cameraUp)) * m_m4View;

	glm::vec3 toRotateAround = glm::cross(m_v3Direction,m_v3cameraUp);
	m_m4View = glm::mat4(glm::rotate(-mouseY * 0.5f, toRotateAround)) * m_m4View;
