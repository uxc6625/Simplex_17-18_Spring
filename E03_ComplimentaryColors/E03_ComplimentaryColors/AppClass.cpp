...
void AppClass::InitVariables(void)
{
	...
	std::vector<glm::vec3> zVertex;

	//vertex 1 - red
	lVertex.push_back(glm::vec3(-1.0f, -1.0f, 0.0f)); //position
	lVertex.push_back(glm::vec3(1.0f, 0.0f, 0.0f)); //color
	//vertex 1 - cyan
	zVertex.push_back(glm::vec3(-1.0f, -1.0f, 0.0f)); //position
	zVertex.push_back(glm::vec3(0.0f, 1.0f, 1.0f)); //color
	...
	//vertex 1 - magenta
	zVertex.push_back(glm::vec3(1.0f, -1.0f, 0.0f)); //position
	zVertex.push_back(glm::vec3(1.0f, 0.0f, 1.0f)); //color

	//vertex 3 - blue
	lVertex.push_back(glm::vec3(0.0f, 1.0f, 0.0f)); //position
	lVertex.push_back(glm::vec3(0.0f, 0.0f, 1.0f)); //color
    //vertex 3 - yellow
	zVertex.push_back(glm::vec3(0.0f, 1.0f, 0.0f)); //position
	zVertex.push_back(glm::vec3(1.0f, 1.0f, 0.0f)); //color
	...
	glBufferData(GL_ARRAY_BUFFER, zVertex.size() * sizeof(glm::vec3), &zVertex[0], GL_STATIC_DRAW);
